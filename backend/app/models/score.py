...
class Feedback(SQLModel, table=True):
    ...
    audio_status: str = Field(default="queued", max_length=20)
    audio_model: Optional[str] = Field(default=None, max_length=50)
    audio_error: Optional[str] = Field(default=None, max_length=500)
    audio_generated_at: Optional[datetime] = Field(default=None)
    created_at: datetime = Field(default_factory=datetime.utcnow)
    updated_at: datetime = Field(default_factory=datetime.utcnow)
